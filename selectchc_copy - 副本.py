...
time.sleep(2)
pilao0 = 'C:\\Users\\xyf\\Desktop\\chc\\pilao0.png'
pyautogui.PAUSE=0.2
shuatu_path = "C:\\Users\\xyf\\Desktop\\chc\\shuatu" 
...
def whilestuck():
   time.sleep(10)
   global stuck 
   stuckrepair_img = ('C:\\Users\\xyf\\Desktop\\chc\\stuck.png')
   max_time = 30
   while True:
...
def load_screen():
    ...
    while True:
        ...
        pilaobuzu_img= 'C:\\Users\\xyf\\Desktop\\chc\\pilaobuzu.png'
        shenyuan_flg_img = 'C:\\Users\\xyf\\Desktop\\chc\\shenyuan.png'
...
#进图检测，进入山脊
def shanji_in():
    shanji_in_img = 'C:\\Users\\xyf\\Desktop\\chc\\shanji_in.png'    
...
def re_in(img_path,cha_type):
    global stuck
    zhuangebixiuli() #修装备
    zero_pilao_path ='C:\\Users\\xyf\\Desktop\\chc\\zero_pilao.png' 
    kong_screen = screen[190:280,226:390]
    loc,conf,w,h=find_image_on_screen(zero_pilao_path,kong_screen) #0疲劳回城
    if conf>0.7: 
       return 1 
    tu_xiuli_path = 'C:\\Users\\xyf\\Desktop\\chc\\xiuli.png' #清背包
...
#装备修理  
def zhuangebixiuli():
    zhuangbeixiuli_image='C:\\Users\\xyf\\Desktop\\chc\\zhuangbeixiuli.png'
...
def fanhui():
    time.sleep(1)
    fanhui_path = 'C:\\Users\\xyf\\Desktop\\chc\\fanhui.png'
...
def shenyuanfanhui():
    ...
    time.sleep(6)
    pilao000 = 'C:\\Users\\xyf\\Desktop\\chc\\pilao0.png'
...
def t1controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t1.png'
...
def t2controll(cha_type):
       global shenyuan_flg
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t2.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t3controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t3.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t4controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t4.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t5controll(cha_type):
       global pilaofuzu_flg 
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t5.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t6controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t6.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t7controll(cha_type):
       global shenyuan_flg
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t7.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t8controll(cha_type):
       global shenyuan_flg
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t8.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t9controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t9.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t10controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t10.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t11controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t11.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t12controll(cha_type):
       global pilaofuzu_flg
       global shenyuan_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t12.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t13controll(cha_type):
       global shenyuan_flg 
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t13.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t14controll(cha_type):
       global shenyuan_flg 
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t14.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t15controll(cha_type):
       global shenyuan_flg 
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t15.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t16controll(cha_type):
       global shenyuan_flg 
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t16.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
...
def t17controll(cha_type):
       global shenyuan_flg 
       global pilaofuzu_flg
       chc_path = 'C:\\Users\\xyf\\Desktop\\chc\\t17.png'
       loc,conf,w,h=find_image_on_screen(chc_path,screen)
       if conf>0.85:   
        click_img(loc,conf,w,h)
        time.sleep(1)
